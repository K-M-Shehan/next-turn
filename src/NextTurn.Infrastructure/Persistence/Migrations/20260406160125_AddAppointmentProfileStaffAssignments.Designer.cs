...
namespace NextTurn.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260406160125_AddAppointmentProfileStaffAssignments")]
    partial class AddAppointmentProfileStaffAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NextTurn.Domain.Appointment.Entities.AppointmentProfileStaffAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AppointmentProfileId", "StaffUserId")
                        .IsUnique()
                        .HasDatabaseName("UX_AppointmentProfileStaffAssignments_ProfileId_StaffUserId");

                    b.ToTable("AppointmentProfileStaffAssignments", (string)null);
                });
