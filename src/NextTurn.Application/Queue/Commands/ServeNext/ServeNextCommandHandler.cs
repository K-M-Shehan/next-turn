...
public sealed class ServeNextCommandHandler : IRequestHandler<ServeNextCommand, QueueEntryActionResult>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        _context.QueueActionAuditLogs.Add(
            QueueActionAuditLog.Create(
                ...
                actionType: QueueActionType.Serve,
                reason: null));
